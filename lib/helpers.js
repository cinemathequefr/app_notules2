 ...
 * "<val0> -<arg1> <val1> <val2> <val3> -<arg2> <val4> -<arg1> <val5>"
 ...
 * @returns {Object} Objet de la forme : { _nokey: [val0], arg1: [val1, val2, val3, val5], arg2: [val4] }
 */
 ...
 *  Les catégories listées dans l'objet de configuration du cycle doivent être sans doublons (pour parer à une erreur fréquente).
